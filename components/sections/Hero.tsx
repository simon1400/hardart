  ...
  return (
    ...
    >
      ...
      {/* The tops of the letters sit on the top edge of the window (the SVG has no top padding).
          ...
          exactly and it turns transparent (still in the accessibility tree as an image). An image, not
      ...
      {/* The claim is the h1 of the page (the wordmark only says the name), same look as before. */}
      ...
      <h1 className="flex grow flex-col justify-end text-right text-claim" data-claim data-exit>
